...
- **Preview before saving:** Compare original and output file sizes side by side, see the amount saved or added, and check whether the result is under 100 KB (1 KB = 1,024 bytes). The dialog also shows output dimensions; cancel to leave the image unchanged.
